...
public class WinDeleteMember extends JDialog {
	...
	public static void main(String[] args) {
		try {
			WinDeleteMember dialog = new WinDeleteMember("");
	 ...
	 * Create the dialog.
	 */
	public WinDeleteMember(String sJumin) {
		Jumin = sJumin;
		setTitle("동문회원 가입");
		...
		btnDelete.setBounds(95, 216, 97, 23);
	...
	protected void deleteMember() {		
		try {
			...
			int result = JOptionPane.showConfirmDialog(null, "정말로 삭제하시겠습니까?", "삭제", JOptionPane.OK_CANCEL_OPTION);
